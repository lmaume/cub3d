...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/21 17:53:45 by mlapique          #+#    #+#             */
/*   Updated: 2025/03/24 15:53:17 by mlapique         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_move(t_eve *eve)
{
	...
	if (mlx_is_key_down(eve->mlx->mlx, MLX_KEY_B))
		eve->walls->mo_zaik = false;
	if (mlx_is_key_down(eve->mlx->mlx, MLX_KEY_V))
		mlx_set_cursor_mode(eve->mlx->mlx, MLX_MOUSE_NORMAL);
	if (mlx_is_key_down(eve->mlx->mlx, MLX_KEY_C))
