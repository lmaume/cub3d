...
{
	if (is_player_in_wall(&eve->map->data, eve->player->plyr_x - cos(eve->player->anglez + M_PI / 2) * 10, eve->player->plyr_y) == false)
		eve->player->plyr_x -= cos(eve->player->anglez + M_PI / 2) * 5;
	if (is_player_in_wall(&eve->map->data, eve->player->plyr_x, eve->player->plyr_y - sin(eve->player->anglez + M_PI / 2) * 10) == false)
		eve->player->plyr_y -= sin(eve->player->anglez + M_PI / 2) * 5;
}
